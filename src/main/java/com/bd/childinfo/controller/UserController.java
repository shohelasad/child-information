...
import com.bd.childinfo.dto.PasswordForm;
...
import com.bd.childinfo.utils.PageWrapper;
import com.bd.childinfo.utils.ValidationUtils;
...
public class UserController {
    ...
    private void checkOwnerShip(User user) {
        ...
        userService.findCurrentLoggedInUser().map(currentLoggedInUser -> {
            boolean isAdminUser = userService.isCurrentUserIsOrganizationUser();
